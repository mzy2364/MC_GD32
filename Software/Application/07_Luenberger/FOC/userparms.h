...
//12V
//#define     MOTOR_PHASE_RESISTANCE                          ((float)0.2f)			// Resistance in Ohms 相电阻
//#define     MOTOR_PHASE_INDUCTANCE                          ((float)0.000188f)		// Inductance in Henrys	 相电感
