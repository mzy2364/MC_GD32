...
{
    timer_channel_output_mode_config(MOTOR_PWM_TIMER,PWM_U_CHANNEL,TIMER_OC_MODE_PWM0);
    timer_channel_output_mode_config(MOTOR_PWM_TIMER,PWM_V_CHANNEL,TIMER_OC_MODE_PWM0);
    timer_channel_output_mode_config(MOTOR_PWM_TIMER,PWM_W_CHANNEL,TIMER_OC_MODE_PWM0);
