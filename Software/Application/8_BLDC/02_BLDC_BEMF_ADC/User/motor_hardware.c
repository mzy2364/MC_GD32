...
//    nvic_irq_enable(TIMER0_Channel_IRQn, 1, 2);
...
//    gpio_init(IDC_AVER_ADC_PORT, GPIO_MODE_AIN, GPIO_OSPEED_MAX, IDC_AVER_ADC_PIN);
    ...
    rcu_periph_clock_enable(BEMFU_ADC_CLK);
    rcu_periph_clock_enable(BEMFV_ADC_CLK);
    rcu_periph_clock_enable(BEMFW_ADC_CLK);
    rcu_periph_clock_enable(IDC_AVER_ADC_CLK);
    
    gpio_init(BEMFU_ADC_PORT, GPIO_MODE_AIN, GPIO_OSPEED_MAX, BEMFU_ADC_PIN);
    gpio_init(BEMFV_ADC_PORT, GPIO_MODE_AIN, GPIO_OSPEED_MAX, BEMFV_ADC_PIN);
    gpio_init(BEMFW_ADC_PORT, GPIO_MODE_AIN, GPIO_OSPEED_MAX, BEMFW_ADC_PIN);
    gpio_init(IDC_AVER_ADC_PORT, GPIO_MODE_AIN, GPIO_OSPEED_MAX, IDC_AVER_ADC_PIN);
}
...
static void adc0_config(void)
{
    ...
    adc_inserted_channel_config(ADC0, IU_INSERTED_CHANNEL, BEMFU_ADC_CHANNEL, ADC_SAMPLETIME_1POINT5);
    adc_inserted_channel_config(ADC0, IV_INSERTED_CHANNEL, BEMFV_ADC_CHANNEL, ADC_SAMPLETIME_1POINT5);
    adc_inserted_channel_config(ADC0, IW_INSERTED_CHANNEL, BEMFW_ADC_CHANNEL, ADC_SAMPLETIME_1POINT5);
    adc_inserted_channel_config(ADC0, IDC_AVER_INSERTED_CHANNEL, IDC_AVER_ADC_CHANNEL, ADC_SAMPLETIME_1POINT5);
    /* ADC trigger config */
