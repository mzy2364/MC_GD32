...
uint16_t vdc_bus_adc = 0;
uint16_t vdc_bus_mv = 0;
uint16_t idc_adc = 0;
uint32_t idc_adc_sum = 0;
float idc_amp = 0;
uint16_t adc_filter_count = 0;
uint16_t adc_filter_buffer[ADC_FILTER_COUNT] = {0};
uint16_t speed_rpm = 0;
extern uint32_t idc_offset;
