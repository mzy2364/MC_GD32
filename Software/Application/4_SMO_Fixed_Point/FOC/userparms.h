...
#define INITIALTORQUE			0.5		// Initial Torque demand in Amps.

#define ENDSPEEDOPENLOOP MINSPEEDINRPM

#define POLEPAIRS      		2       // Number of pole pairs
#define PHASERES			((float)6.97)	//38 Phase resistance in Ohms.
#define PHASEIND_LQ		    ((float)0.00535)		//95
#define PHASEIND			((float)0.00535)//(Ld+Lq)/2 Phase inductance in Henrys.

#define NOMINALSPEEDINRPM       3000
#define MINSPEEDINRPM			1000	// Minimum speed in RPM. Closed loop will operate at this
